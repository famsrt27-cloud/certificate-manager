...
export interface PublicCertificateDownloadAuthorizationRecord {
...
export const findPublicCertificateDownloadAuthorization = async (
  database: DatabaseClient,
  publicIdentifier: string
): Promise<PublicCertificateDownloadAuthorizationRecord | null> => {
