    ...
    <main className="mx-auto flex min-h-screen max-w-3xl items-center px-6 py-16">
      <section aria-labelledby="foundation-title" className="space-y-4">
        ...
        <p className="max-w-2xl text-lg leading-8 text-slate-700">
          Secure admin authentication, server-side sessions and tenant-aware authorization are ready.
          Project, training and participant features remain intentionally out of scope.
        </p>
