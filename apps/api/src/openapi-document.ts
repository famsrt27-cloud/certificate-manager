import {
  ...
  JobResponseSchema, LoginRequestSchema, LoginResponseSchema, MfaCodeRequestSchema, MfaCompletionResponseSchema,
  LogoutResponseSchema, ParticipantImportInspectResponseSchema,
...
export const openApiDocument = {
  ...
  paths: {
    ...
    "/api/admin/auth/login": { post: { security: [], requestBody: jsonRequest(LoginRequestSchema),
      responses: { ...response(200, LoginResponseSchema), ...response(400, ErrorResponseSchema),
        ...response(401, ErrorResponseSchema), ...response(429, ErrorResponseSchema), ...response(503, ErrorResponseSchema) } } },
    "/api/admin/auth/mfa": { post: { security: [], requestBody: jsonRequest(MfaCodeRequestSchema),
      responses: { ...response(200, MfaCompletionResponseSchema), ...response(400, ErrorResponseSchema),
        ...response(401, ErrorResponseSchema), ...response(403, ErrorResponseSchema), ...response(503, ErrorResponseSchema) } } },
